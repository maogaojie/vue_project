				...
				<form method="post" name="register">
					<fieldset>
						...
						<div id="submit-wrapper">
							<input type="button"  class="login primary"  value="点击确定" @click="register">
						...
						<div class="login-additional">
							<div class="lost-password-container">
								<a id="lost-password" href="http://123.57.61.168/index.php/login?clear=1">
									忘记密码？ </a>
